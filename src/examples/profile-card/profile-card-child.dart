...
class ProfileCardChild extends StatelessWidget {
  const ProfileCardChild({super.key});
  ...
  static const _tags = ['Uncollectable', 'Late', '+2'];
          ...
          children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const Text('3M Funded', style: TextStyle(fontFamily: 'Lexend', fontSize: 12, fontWeight: FontWeight.w400, color: Color(0xFF3F6212))), // --accent-lime-foreground
                        ],
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Mark Zuckerberg Carter', style: TextStyle(fontFamily: 'Lexend', fontSize: 15, fontWeight: FontWeight.w600, height: 1.47, color: Color(0xFF2E2B2B))), // --foreground
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Row(children: [
                        const Icon(Icons.lock_person_outlined, size: 16, color: Color(0xFFADA5A5)),
                        const SizedBox(width: 4),
                        const Text('Sarah Thomas', style: TextStyle(fontFamily: 'Lexend', fontSize: 12, color: Color(0xFFADA5A5))),
                        const SizedBox(width: 12),
                        const Text('·', style: TextStyle(fontFamily: 'Lexend', fontSize: 15, fontWeight: FontWeight.w600, color: Color(0xFF7A7272))),
                        const SizedBox(width: 12),
                        const Icon(Icons.cake_outlined, size: 16, color: Color(0xFFADA5A5)),
                        const SizedBox(width: 4),
                        const Text('5Y 11M', style: TextStyle(fontFamily: 'Lexend', fontSize: 12, color: Color(0xFFADA5A5))),
                      ]),
                    ],
                  ),
                  const SizedBox(height: 8),
                  ...
                  Row(
                    ...
                    children: _schedule.map((d) => Container(
                      ...
                      decoration: BoxDecoration(
                        color: d.active ? const Color(0xFFD7E8FF) : const Color(0xFFF4F4F4), // --accent-blue / --accent-gray-subtler
                        borderRadius: BorderRadius.circular(4),
                      ),
