...
import { SwitchDetail } from "@/components/docs/SwitchDetail";
...
import { SwitchDefault } from "@/examples/switch/switch-default";
import { SwitchWithLabel } from "@/examples/switch/switch-with-label";
...
const INSTALL_CODE = `cp src/components/figma/Switch.tsx your-project/components/Switch.tsx`;
const USAGE_IMPORT = `import { Switch } from "@/components/figma/Switch"`;
const USAGE_CODE = `<Switch />
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10 font-lexend">
      ...
      <p className="leading-7 text-secondary-foreground">
        A control that allows the user to toggle between checked and not checked. Supports controlled and uncontrolled usage, keyboard navigation, and form compatibility via a hidden native checkbox.
      </p>
      ...
      <div className="mt-3">
        <ComponentPreview name="switch/switch-default">
          <SwitchDefault />
        </ComponentPreview>
      </div>
      ...
      <div className="mt-3">
        <ComponentPreview name="switch/switch-with-label">
          <SwitchWithLabel />
        </ComponentPreview>
      </div>
      ...
      <h3 id="api-switch" className="mt-8 scroll-mt-20 text-lg font-semibold text-foreground">Switch</h3>
      <div className="mt-3 overflow-x-auto rounded-lg border border-border">
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-border">
            <tr><td className="px-4 py-3 font-mono text-xs">checked</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">boolean</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">—</td></tr>
            <tr><td className="px-4 py-3 font-mono text-xs">defaultChecked</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">boolean</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">false</td></tr>
            ...
            <tr><td className="px-4 py-3 font-mono text-xs">aria-label</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">string</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">—</td></tr>
            ...
            <tr><td className="px-4 py-3 font-mono text-xs">id</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">string</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">—</td></tr>
            <tr><td className="px-4 py-3 font-mono text-xs">name</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">string</td><td className="px-4 py-3 font-mono text-xs text-secondary-foreground">—</td></tr>
